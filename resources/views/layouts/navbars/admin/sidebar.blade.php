...
<aside class="sidenav navbar navbar-vertical bg-white navbar-expand-xs border-0 border-radius-xl my-2 mx-2 fixed-start" id="sidenav-main">
    ...
    <div class="" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item mt-2">
          <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Laravel </h6>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
    <a class="nav-link" data-bs-toggle="collapse" href="#submenuJadwal" role="button" aria-expanded="false" aria-controls="submenuJadwal">
        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <svg width="12px" height="20px" viewBox="0 0 40 40" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <title>spaceship</title>
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
    ...
    <div class="collapse" id="submenuJadwal">
        <ul class="nav ms-4 ps-3">
            <li class="nav-item">
                <a class="nav-link" href="{{ url('kamar') }}">
                    <span class="nav-link-text">SubTest</span>
                </a>
            </li>
        </ul>
    </div>
