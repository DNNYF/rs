<aside class="sidenav navbar navbar-vertical bg-white navbar-expand-xs border-0 border-radius-xl my-2 mx-2 fixed-start" id="sidenav-main">
    <div class="sidenav-header">
      <i class="fas fa-times p-3 cursor-pointer text-secondary opacity-5 position-absolute end-0 top-0 d-none d-xl-none" aria-hidden="true" id="iconSidenav"></i>
      <a class="align-items-center d-flex m-0 navbar-brand text-wrap" href="{{ route('dashboard') }}">
        @php
            $logoPath = \App\Models\Pengaturan::ambil('logo_aplikasi');
            $namaAplikasi = \App\Models\Pengaturan::ambil('nama_aplikasi', config('app.name'));
        @endphp
        @if($logoPath)
            <img src="{{ asset('storage/' . $logoPath) }}" class="navbar-brand-img h-100" alt="Logo {{ $namaAplikasi }}">
        @else
            <img src="{{ asset('assets/img/logo-ct.png') }}" class="navbar-brand-img h-100" alt="Default Logo">
        @endif
        <span class="ms-3 font-weight-bold">{{ $namaAplikasi }}</span>
      </a>
    </div>
    ...
    <div class="" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link {{ (Request::is('rawat-jalan') ? 'active' : '') }} " href="{{ url('rawat-jalan') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item mt-2">
          <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Lara </h6>
        </li>
        <li class="nav-item">
          <a class="nav-link {{ (Request::is('info-pasien') ? 'active' : '') }} " href="{{ url('info-pasien') }}">
              <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
          <a class="nav-link {{ (Request::is('info-dokter') ? 'active' : '') }} " href="{{ url('info-dokter') }}">
              <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                  <svg width="12px" height="12px" viewBox="0 0 46 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                      <title>customer-support</title>
                      <g id="Basic-Elements" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
              ...
              <span class="nav-link-text ms-1">Daftar Dokter</span>
          </a>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link {{ (Request::is('manajemen-user') ? 'active' : '') }}" href="{{ url('manajemen-user') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="12px" height="12px" viewBox="0 0 46 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <title>customer-support</title>
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <li class="nav-item">
          <a class="nav-link {{ (Request::is('vod') ? 'active' : '') }}" href="{{ url('vod') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <span class="nav-link-text ms-1">VOD</span>
          </a>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link {{ (Request::is('manajemen-pasien') ? 'active' : '') }}" href="{{ url('manajemen-pasien') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="12px" height="12px" viewBox="0 0 46 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <title>customer-support</title>
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            ...
            <span class="nav-link-text ms-1">Manajemen Pasien</span>
          </a>
        </li>
        <li class="nav-item">
