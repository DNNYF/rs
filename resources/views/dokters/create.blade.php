...
<div class="container mt-5">
    ...
    <div class="card">
        <div class="card-header">
            <h5 class="card-title">Formulir Pendaftaran Dokter</h5>
        </div>
        <div class="card-body">
            <form action="{{ route('dokters.store') }}" method="POST" class="form-horizontal">
                @csrf
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="biaya_pelayanan" name="biaya_pelayanan" placeholder="Rp 0" required>
                </div>
                <div class="mb-3">
