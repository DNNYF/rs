...
<div class="container mt-5">
    ...
    <form action="{{ route('pasiens.update', $pasien->id) }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="nama_lengkap" name="nama_lengkap" value="{{ old('nama_lengkap', $pasien->nama_lengkap) }}">
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="date" class="form-control" id="tgl_lahir" name="tgl_lahir" value="{{ old('tgl_lahir', $pasien->tgl_lahir) }}">
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="number" class="form-control" id="tb" name="tb" value="{{ old('tb', $pasien->tb) }}">
        </div>
