...
<div class="container mt-5">
    <div class="d-flex align-items-center mb-4">
        <a href="{{ route('operator.index') }}" class="me-3">
    ...
    <form action="{{ route('operator.update', $operators->id) }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="name" name="name" value="{{ old('name', $operators->name) }}" required>
        </div>
        <div class="mb-3">
            <label for="email" class="form-label">Email</label>
            <input type="email" class="form-control" id="email" name="email" value="{{ old('email', $operators->email) }}" required>
        </div>
        <div class="mb-3">
            <label for="phone" class="form-label">No Telepon</label>
            <input type="text" class="form-control" id="phone" name="phone" value="{{ old('phone', $operators->phone) }}" required>
        </div>
        <div class="mb-3">
            <label for="about_me" class="form-label">Keterangan</label>
            <input type="text" class="form-control" id="about_me" name="about_me" value="{{ old('about_me', $operators->about_me) }}" required>
        </div>
        <div class="mb-3">
